...
public class SingInPage {
    ...
    public static final Target LBL_USERNAME_ALARM = Target.the("ALARAM Username")
    ...
    public static final Target LBL_PASSWORD_ALARM = Target.the("ALARAM Password")
    ...
    public static final Target LBL_PASSWORD_REPEAT_ALARM = Target.the("ALARAM Password Repeat")
            .located(By.xpath("//android.widget.TextView[@index='6']"));
    ...
    public static final Target LBL_EMAIL_ALARM = Target.the("ALARAM email")
            .located(By.xpath("//android.widget.TextView[@index='8']"));
